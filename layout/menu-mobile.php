<input type="checkbox" id="check" class="check-menu">
    ...
    <nav class="menu-mobile">
        <ul class="lista-menu-mobile">
            <li><a href="index.php" class="link-menu-mobile">NOTÍCIAS</a></li>
            <?php if (isset($_SESSION['TOKEN'])) : ?>
            <li><a href="cadastrar.php" class="link-menu-mobile">CADASTRAR NOTÍCIA</a></li>
            <li><a href="categorias.php" class="link-menu-mobile">CATEGORIAS</a></li>
            <li><a href="cadastrar-categoria.php" class="link-menu-mobile">CADASTRAR CATEGORIA</a></li>
            <li><a href="usuarios.php" class="link-menu-mobile">USUÁRIOS</a></li>
            <li><a href="cadastrar-usuario.php" class="link-menu-mobile">CADASTRAR USUÁRIO</a></li>
